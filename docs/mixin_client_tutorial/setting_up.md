...
![New project](../../_media/mxntutorial/ST_NEW_PROJ.png)
...
![Run decomp task](../../_media/mxntutorial/ST_DECOM_TASK.png)

**This will take some time**

Next click the elephant reload button to get gradle to configure your project

![Configure project](../../_media/mxntutorial/BUILD_GRADLE.png)
...
![Edit configurations button](../../_media/mxntutorial/ST_EDIT_CONF.png)

Then change the module to `PROJECT_NAME.main`, and click apply
![Configuration screen](../../_media/mxntutorial/ST_CONF_SCREEN.png)
* * *
...
![Run button](../../_media/mxntutorial/ST_RUN.png)
